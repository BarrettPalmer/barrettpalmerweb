...
<template>
  <header class="flex items-center justify-between rounded-full bg-white/70 px-5 py-3 text-sm font-medium text-slate-600 shadow-[0_10px_40px_rgba(15,23,42,0.08)] backdrop-blur">
